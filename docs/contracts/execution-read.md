# Lectura exacta de ejecución

Fuente: [confirmación backend](../archive/backend/contrato-front-lectura-exacta-supervisor.md). Endpoint desplegado según backend; ver [estado](../integration/status.md).
